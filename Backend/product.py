...
class Product:
    ...
    def __init__(self, product_id, name, category, price, stock, seller_id, description=None, rating=None, warranty=None,offer=0):
    ...
    def to_sql(self):
        ...
        print(f"INSERT INTO Product VALUES('{self.product_id}', '{self.name}', '{self.category}', '{self.description}', {self.price}, {self.stock}, {self.rating}, '{self.seller_id}', {self.warranty}, {self.offer})")
        con.commit()
        con.close()
